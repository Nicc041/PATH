...
# Graph Navigation System - Module Overview
...
### CampusMapParser.hs
**Purpose:** Parses nodes and edges specifically for campus map data, including:
...
### Main.hs
**Purpose:** Acts as the entry point for the program, handling:
- User input
- Invoking appropriate parsers and algorithms
- Displaying results
